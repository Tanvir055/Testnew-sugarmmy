...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("AnonXMusic/assets/Brandedwel2.png")
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "AnonXMusic/assets/Brandedwel2.png"
...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ @TanvirAhmed_555
➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/Sugar_mmy_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
